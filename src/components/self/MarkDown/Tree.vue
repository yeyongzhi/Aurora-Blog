...
import { FolderCode, ChevronRightIcon, ChevronDownIcon } from 'lucide-vue-next'
                ...
                <Collapsible :defaultOpen="true">
                    ...
                    <CollapsibleContent>
                        <div class="mt-2 flex flex-col gap-y-2 pl-4" v-if="item.children && item.children.length > 0">
                            <div :class="`flex items-center justify-between cursor-pointer ${props.currentKey === child.key ? 'bg-primary text-primary-foreground' : ''}`"
