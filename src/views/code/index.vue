...
const { articleMissing, treeData, noteKey, mdFilePath, treeError, treeLoading, initTreeData, handleArticleChanged, slideMenuVisible, toggleSlideMenu } = useArticleCollection('code')
