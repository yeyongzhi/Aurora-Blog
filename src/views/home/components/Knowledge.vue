...
<template>
    <div class="grid grid-cols-3 gap-4 mb-8 mt-4">
        <Card v-for="item in props.data" :key="item.title" class="gap-4 py-4 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary cursor-pointer">
            <CardHeader>
